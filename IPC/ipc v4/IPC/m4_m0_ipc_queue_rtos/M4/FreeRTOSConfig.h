...
/*-----------------------------------------------------------
 * Cortex M3 / M4 Application specific definitions.
 *
...
/* The lowest priority. */
/* Priority 7, or 224 as only the top three bits are implemented. */
/* Port uses CMSIS, priority from 0 to 7 */
...
value needs to be equal to or greater than 5 (on the Cortex-M4 the lower the
