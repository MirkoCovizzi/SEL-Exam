...
#define configBITMASK_SYSCALL_IRQ  (1 << RITIMER_WDT_IRQn)
 ...
 * Not applicable if another timer than systick is used 
*/
 ...
 *-----------------------------------------------------------*/
extern void vConfigOsTimer( void );
#define portCONFIGURE_OS_TIMER() vConfigOsTimer()
